...
let returnConfig = {};
returnConfig[configR3B.key] = configR3B;
returnConfig[configR1.key] = configR1;
returnConfig[configR2A.key] = configR2A;
returnConfig[configR2AExcel.key] = configR2AExcel;
returnConfig[configR2B.key] = configR2B;
returnConfig[configR4.key] = configR4;
returnConfig[configR4A.key] = configR4A;
returnConfig[configR9.key] = configR9;
...
function connect() {
  return new Promise(function (resolve, reject) {
    chrome.tabs.query({ active: true, currentWindow: true }, function (tabs) {
      port = chrome.tabs.connect(tabs[0].id, { name: "gkb-gst-assistant" });
...
async function startupAsync() {
  ...
  getElement("businessName").innerHTML = session.businessName;
